...
<TITLE>社科院电子所务::::::::::</TITLE>
 ...
 <!--
	...
	function openwin6(){
	window.open ("tian_jia_yong_hu_zu.jsp", "newwindow2", "height=500, width=400, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
			...
			<TABLE height=62 cellSpacing=1 borderColorDark=#999999 cellPadding=2 width="95%" borderColorLight=#77677c border=0>
              ...
              <TR bgColor=#ebf0f1>
                ...
                <TD class=black vAlign=top align=left width=131 height=18>
					<a href="tong_shi.jsp?GroupId=485" title="查看该组成员">同事</a>
				</TD>
