...
<link href="../../css/style.css" rel="stylesheet" type="text/css" />
 ...
 <!--
    ...
    window.open ("duan_xiao_xi.jsp", "newwindow2", "height=260, width=310, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 

      } 
	  	 function openwin3() { 
	
    window.open ("xin_fen.jsp", "newwindow2", "height=260, width=310, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no") 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%"  background="../../images/item-addressrightback.gif" border="0">
        ...
        <tr>
          ...
          <td width="813" valign="bottom" align="right"><img border="0" src="../../images/icon-add.gif" align="absmiddle" width="14" height="14"> 
              ...
              <A href="yong_hu_zu.jsp" title="查看用户组">用户组</A>&nbsp;&nbsp;
			...
			<TABLE height=62 cellSpacing=1 borderColorDark=#999999 cellPadding=2 width="95%" borderColorLight=#77677c border=0>
              ...
              <TR bgColor=#ebf0f1>
                ...
                <TD width=250 height=18 class=black valign=bottom align=left>
					...
					<A href="tong_shi.jsp?GroupId=485">同事</A>&nbsp;
