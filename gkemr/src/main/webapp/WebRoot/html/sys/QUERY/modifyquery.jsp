    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">修改查询</td>
          </tr>
      </table></td>
    </tr>
  </table>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="td01"  id=PLList>
  <tr>
    <td width="120" align="center" class="td_form01">查询名称</td>
    <td colspan="3" class="td_form02"><input name="checkbox" type="text" class="input" value="地区业务司现职干部" size="60" >      <input type="checkbox" name="checkbox" value="checkbox">
保存为默认查询 </td>
    </tr>
  <tr>
    <td align="center" class="td_form01">选择使用指标集</td>
    <td colspan="3" class="td_form02"><select name="selecttable" onChange="viewinfo()">
      <option value="0">请选择</option>
      <option value="1" selected>人员基本信息</option>
  ...
  <tr>
    <td align="center" class="td_form01">选择显示指标项</td>
    <td colspan="3" class="td_form02"><textarea name="viewfield" cols="70" rows="4" >,员工编号,姓名,性别,年龄,民族,政治面貌,户口所在地,进入本单位时间,婚姻状况,身份证号</textarea></td>
    </tr>
  <tr>
    <td colspan="4">
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="2" id="baseinfo" style="display:visible ">
          <tr>
            <td width="25%"><input name="checkbox" type="checkbox" onClick="addinfo(',员工编号')" value="checkbox" checked>
            员工编号</td>
            <td width="25%"><input name="checkbox" type="checkbox" onClick="addinfo(',姓名')" value="checkbox" checked>
            姓名</td>
            <td width="25%"><input type="checkbox" name="checkbox" value="checkbox" onClick="addinfo(',曾用名')">
            曾用名</td>
            <td width="25%"><input name="checkbox" type="checkbox" onClick="addinfo(',性别')" value="checkbox" checked>
            性别</td>
          </tr>
          <tr>
            <td><input type="checkbox" name="checkbox" value="checkbox" onClick="addinfo(',出生日期')">
            出生日期</td>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',年龄')" value="checkbox" checked>
            年龄</td>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',民族')" value="checkbox" checked>
            民族</td>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',政治面貌')" value="checkbox" checked>
            政治面貌</td>
          </tr>
          <tr>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',婚姻状况')" value="checkbox" checked>
            婚姻状况</td>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',健康状况')" value="checkbox">
            健康状况</td>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',户口所在地')" value="checkbox" checked>
            户口所在地</td>
            <td><input type="checkbox" name="checkbox" value="checkbox" onClick="addinfo(',籍贯')">
            籍贯</td>
          </tr>
          <tr>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',身份证号')" value="checkbox" checked>
            身份证号</td>
            ...
            血型</td>
            <td><input name="checkbox" type="checkbox" onClick="addinfo(',进入本单位时间')" value="checkbox" checked>
            进入本单位时间</td>
          </tr>
        </table>
  ...
  <tr>
    ...
    <td align="right" bgcolor="#FFFFFF" ><input name="Button" type="button" class="buttonface" onClick="newHospitalVisit()" value="增加条件"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  align="center" class="td07" ><select>
        <option>请选择</option>
        <option>员工编号</option>
        <option>姓名</option>
        <option>曾用名</option>
    ...
    <td  align="center" class="td07" ><select name="select">
        <option>包含</option>
        <option>不包含</option>
    ...
    <td  align="center" class="td07" ><input name="textfield" type="text" class="input" value="男"></td>
    <td  align="center" class="td07" ><select name="select">
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><input name="Button" type="button" class="buttonface" value="  查询  ">
      <input name="Button" type="button" class="buttonface" value="  保存  "></td>
  </tr>
</table>
<script>
allCount=7
