...
<br>
  ...
  <table width="95%" align=center border="0" cellspacing="0" cellpadding="5">
     <tr>
      ...
      <td class="td_form02">
        <input type="text" name="setName" size="40" value="" id="10" next="15" onKeyPress="gotoNextInput(this)" onFocus="{obtainFocus(this),this.select()}" class="input" alt="代码集名称|0|s|50">
      </td>
    </tr>
    <tr>
      <td class="td_form01">国标代码</td>
      <td class="td_form02">
     <input type="text" name="setDesc" size="40" value="" id="15" next="20" onKeyPress="gotoNextInput(this)" onFocus="{obtainFocus(this),this.select()}" class="input" alt="国标代码|1|s|50">
      </td>
    </tr>
    <tr>
      ...
      <td class="td_form02">
        <select name="setLayer"><option value="1" selected="selected">录入到任意层次</option>
          <option value="0">录入到最低层次</option></select>
      </td>
    </tr>
    <tr>
