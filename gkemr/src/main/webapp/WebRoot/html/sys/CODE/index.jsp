...
function toHandle(id,type){
    if(type==1){
	    list.location="/sys/codeSetEdit.do?setId="+id+"&act="+2;
    }else if(type==2){
        list.location="/sys/codeItemEdit.do?itemId="+id+"&act="+2;
    }else if(type==0){
        list.location="/sys/codeSetList.do";
    }
}
</script>
  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">代码管理</td>
      </tr>
    </table></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="220" valign="top" id="showTree"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><iframe id="tree" name="tree" frameborder="0" framespacing="0" scrolling="auto" width="100%" src="code-tree.jsp"></iframe></td>
      </tr>
    </table></td>
    ...
    <td valign="top"><table width="100%" border=0 cellpadding="0" cellspacing="0">
      <tr>
        <td><iframe id="list" name="list" frameborder="0" framespacing="0" scrolling="yes" width="100%" src="codegroup-list.jsp"></iframe></td>
      </tr>
    </table></td>
  </tr>
</table>
