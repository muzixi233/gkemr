...
<input name="setName" type="hidden" value= "课题报销信息子集">
<input name="itemId" type="hidden" >
  <table width="95%"  border="0" cellspacing="2" cellpadding="0" align=center>
    <tr>
      <td><font color=red >指标集：课题报销信息子集</font></td>
      <td  align="right">
