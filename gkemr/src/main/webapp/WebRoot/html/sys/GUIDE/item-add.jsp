...
<table width=95% align="center" border="0"  cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td  class="td_form02"><input name="itemName" type="text" class="input" id="15" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" value="" size="40" alt="指标项名称|0|s|100" next="20"> </td>
  ...
  <tr>
    ...
    <td class="td_form02"><input type="text" name="itemDataLength" value="文本" id="35" next="40" onKeyPress="gotoNextInput(this)" onFocus="{obtainFocus(this),this.select()}" class="input" alt="数据长度|1|i|20">
