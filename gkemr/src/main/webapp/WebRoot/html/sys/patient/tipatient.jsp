  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">当日住院病人</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr>
    ...
    <td class="td07">骨科</td>
    <td class="td07"><a href="/patient/updatepatient?id=<%=p.getpId() %>" target="mainFrame">&nbsp;&nbsp;详情</a></td>
  </tr>
  <%}}%>
...
%>
  <tr>
    ...
    <td class="td07">骨科</td>
    <td class="td07"><a href="/patient/updatepatient?id=<%=pation.getpId() %>" target="mainFrame" >&nbsp;&nbsp;详情</a></td>
  </tr>
  <%}}%>
