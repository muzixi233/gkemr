...
<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <input name="button" type="button"  class="button_select" onClick="javascript:openwindow('editresult1a.jsp','',700,700)"></td>
  ...
  <tr>
    ...
    <td class="td_form02"><input name="textfield224" type="text" class="input" value="社会研究所" size="30"></td>
...
公开    
<input type="radio" name="radiobutton" value="radiobutton">保密
   </td>
...
第一作者    
<input type="radio" name="radiobutton" value="radiobutton">其他作者</td>
  </tr>
   <tr>
   ...
   <tr>
<td class="td_form02"><div id="divMember2">
  从超星成果库选择<br>
      附件1:
