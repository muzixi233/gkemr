...
<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="td_form02"><input name="textfield222" type="text" class="input" size="30">
        <input name="Submit3" type="button" class="button_select" onClick="windowOpen('resultname.jsp','','','500','350','yes','200','200')">
    </td>
  ...
  <tr>
    <td class="td_form01">成果内容提要</td>
     ...
     <td class="td_form02"><textarea name="textarea6" cols="40" rows="4"></textarea>
（最多2000字）</td>
  </tr>
  <tr>
    <td rowspan="2" class="td_form01">成果社会评价</td>
    <td rowspan="2" class="td_form02"><textarea name="textarea3" cols="40" rows="4"></textarea>
    （最多2000字）</td>
  ...
  <tr>
    <td class="td_form01">查看全文</td>
     <td class="td_form02"><input type="file" class="input2" size="25"></td>
  </tr>
  <tr>
  ...
  <input type="radio" name="radiobutton" value="radiobutton">否</td>
    ...
    <td class="td_form02"><input name="textfield22232" type="text" class="input" size="30">
      ...
      <br>
（如是发表在期刊杂志上的成果，只需精确到年月即可，例如 2005-12）</td>
  </tr> 
  <tr>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><input name="Submit2" type="submit" class="buttonface" value="  提交  " onClick="location.href='myresult.jsp'">
