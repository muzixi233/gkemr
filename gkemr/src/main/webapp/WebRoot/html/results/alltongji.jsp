...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="td_form02">
      <input name="checkbox"  type="checkbox" id="mycheckbox" onClick="display()">
    需要累计汇总</td>
  </tr>
</table>
<br>
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input name="Submit" type="button" class="buttonface" value="  确定  " onClick="location.href='allstaresults.jsp'"></a>
  </tr>
</table>
<br>
</body>
