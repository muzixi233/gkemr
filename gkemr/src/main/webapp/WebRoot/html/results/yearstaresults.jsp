...
oDownload.startDownload('yeartongji.jsp',onDownloadDone)
</script> 

<table width="95%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC" class="table02">
  <tr> 
  	<td nowrap class="td04">序号</td>
  	<td nowrap class="td04">成果类别</td>
  	<td nowrap class="td04">成果名称</td>
  	<td nowrap class="td04">成果形式</td>
  	<td nowrap class="td04">署名人</td>
  	<td nowrap class="td04">课题人数</td>
  	<td nowrap class="td04">发表或出版单位</td>
  	<td nowrap class="td04">发表或出版时间</td>
  	<td nowrap class="td04">备注</td>
  </tr>
  <tr> 
    <td >&nbsp;</td>
    <td >&nbsp;</td>
