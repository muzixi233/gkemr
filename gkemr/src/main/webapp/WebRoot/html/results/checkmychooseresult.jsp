  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">查看我的成果核对</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
  <tr> 
    ...
    <td nowrap class="td_top">成果年度</td>
    <td nowrap class="td_top">是否通过</td>
    <td nowrap class="td_top">查看详细</td>

  </tr>

  <tr> 
    <td class="td_02">当前中国人的社会分层想像</td>
    <td class="td_02">2006</td>
    <td class="td_02">通过</td>
