...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="td_form02"><textarea name="textarea2" cols="80" rows="4"></textarea></td>
  </tr>
  <tr>
    <td class="td_form01">&nbsp;</td>
    <td class="td_form02"><input name="checkbox"  type="checkbox" id="checkbox" onClick="display()">
      需要累计汇总</td>
  </tr>
</table>
<br>
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input name="Submit" type="button" class="buttonface" value="  确定  " onClick="location.href='yearstaresults.jsp'"></a>
  </tr>
</table>
<br>
</body>
