...
<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
   ...
   <tr>
    <td class="td_form01">被申报人</td>
    <td class="td_form02"><input name="textfield2" type="text" class="input" size="30"></td>
  ...
  <tr>
    ...
    <input name="Submit3" type="button" class="button_select" onClick="windowOpen('resultname.jsp','','','500','350','yes','200','200')"></td>
...
（最多2000字）</td>
  ...
  <tr>
    <td class="td_form01">成果社会评价</td>
     <td class="td_form02"><textarea name="textarea3" cols="40" rows="4"></textarea>
     （最多2000字）</td>
     <td class="td_form01">&nbsp;</td>
     <td class="td_form02">&nbsp;</td>
  </tr>
