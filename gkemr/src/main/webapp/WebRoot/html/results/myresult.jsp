  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">查看我的成果</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
  <tr> 
    <td width="24%" nowrap class="td_top">成果名称</td>
    <td width="24%" nowrap class="td_top">成果年度</td>
    <td width="12%" nowrap class="td_top">是否通过</td>
   <td width="24%" nowrap class="td_top">查看详细</td>
    <td width="24%" nowrap class="td_top">附加下载</td>
  </tr>
  ...
  <tr> 
    ...
    <td class="td_02"><a href="moreresultcheck.jsp" target="_blank">&nbsp;&nbsp;>>></a></td>
  <td class="td_02"><a href="#">下载</a></td>
  </tr>
  <tr> 
    <td class="td_01">&nbsp;</td>
    <td class="td_01">&nbsp;</td>
