...
-->
 ...
 <center>
   ...
   <tr>
     <td class="td_top" width="40" align="center">序号</td>
     <td width="319" class="td_top">手续名称</td>
     <td width="338" class="td_top">&nbsp;详细信息</td>
     </tr>
      <tr>
         <td align="center" class="td07">1</td>
         <td class="td07">  刘岳 提交新闻申报以通过时间   2005-10-15</a></td>
		 <td class="td_01"><a href="xiang_xi_xinxi.jsp" target="_blank" onClick="javascript:openwindow('moremessage.jsp','',400,500)"> 查看</a></td>
 
         <td width="2" class="td07">&nbsp;</td>
      </tr>
      <tr>
