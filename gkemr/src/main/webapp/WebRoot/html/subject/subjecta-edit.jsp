...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     <td class="td_page">您目前正在进行<span class="style2">修改课题</span>操作：　<img src="../../images/2-2.gif" width="3" height="5" align="absmiddle"> <a href="subject-edit.jsp">社科基金课题</a>　<img src="../../images/2-2.gif" width="3" height="5" align="absmiddle"> <a href="subjecta-edit.jsp">院重点及其他课题</a></td>
   </tr>
 </table>
 <br>
 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
...
<tr>
    <td class="td_form01">咨询费资料收集费</td>
    <td class="td_form02"><input name="textfield22" type="text" class="input" size="60"></td>
  </tr>
  <tr>
    <td class="td_form01">调研费</td>
    <td class="td_form02"><input name="textfield22" type="text" class="input" size="60"></td>
  </tr>
  <tr>
