              ...
              <td colspan="2"><br>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td nowrap><a href="tree_01.jsp" target="tree" class="a02">部机关</a>
                    ...
                    <div id="menu_1">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td nowrap><a href="tree_05.jsp" target="tree" class="a02">地区业务司</a>
                            <input type="checkbox" name="checkbox" value="checkbox"></td>
                        </tr>
                      </table>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"><img src="../../images/tree_07.gif" width="19" height="20"></td>
                          <td width="19"><img src="../../images/tree_08.gif" width="19" height="20"></td>
                          <td nowrap><a href="tree_06.jsp" target="tree" class="a02">行政部门</a>
                            <input type="checkbox" name="checkbox" value="checkbox"></td>
                        </tr>
                      </table>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"><img src="../../images/tree_27.gif" width="19" height="20"></td>
                          <td nowrap><a href="tree_02.jsp" target="tree" class="a02">部属</a>
                            <input type="checkbox" name="checkbox" value="checkbox"></td>
                        </tr>
                      </table>
                    <div id="menu_2" style="DISPLAY: none">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"><img src="../../images/tree_27.gif" width="19" height="20"></td>
                          <td nowrap><a href="tree_03.jsp" target="tree" class="a02">驻外机构</a>
                            <input type="checkbox" name="checkbox" value="checkbox"></td>
                        </tr>
                      </table>
                      <div id="menu_3">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="19"><img src="../../images/tree_07.gif" width="19" height="20"></td>
                            <td width="19"><img src="../../images/tree_08.gif" width="19" height="20"></td>
                            <td nowrap><a href="tree_04.jsp" target="tree" class="a02">美大地区</a>
                              <input type="checkbox" name="checkbox" value="checkbox"></td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
