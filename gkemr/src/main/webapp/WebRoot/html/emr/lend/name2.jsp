                    ...
                    <div id="menu_1" style="DISPLAY: none">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td nowrap><a href="../html/bbs/bbs.jsp" target="mainFrame" class="a03">科研处</a></td>
                        </tr>
                      </table>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"><img src="../../../images/tree_23.gif" width="19" height="20"></td>
                          <td width="19"><img src="../../../images/tree_08.gif" width="19" height="20"></td>
                          <td nowrap><a href="../../html/bbs/bbs.jsp" target="mainFrame" class="a03">办公室</a></td>
                        </tr>
                      </table>
                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"><img src="../../../images/tree_23.gif" width="19" height="20"></td>
                          <td width="19"><img src="../../../images/tree_08.gif" width="19" height="20"></td>
                          <td nowrap><a href="../../html/bbs/setbbs.jsp" target="mainFrame" class="a03">所领导</a></td>
                        </tr>
                      </table>
                    </div>
