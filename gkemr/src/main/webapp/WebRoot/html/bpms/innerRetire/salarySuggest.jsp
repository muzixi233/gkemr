...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr nowrap> 
      <td  class=td_form01 width="90">月退养生活费</td>
      <td  class=td_form02 > 
        <input name="A001013" type="text" class="input"   id="A001013" next="A001014" alt="招聘岗位|1|d|||" value="" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" ></td>
    </tr>    
    <tr nowrap> 
      <td  class=td_form01>付至年月</td>
      <td  class=td_form02 > 
        <input name="A001013" type="text" class="input"   id="A001013" next="A001014" alt="招聘岗位|1|d|||" value="" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" >
