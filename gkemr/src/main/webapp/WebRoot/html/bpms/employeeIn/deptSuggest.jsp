...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">录入各部门审核意见</td>
          </tr>
      </table></td>
    </tr>
  </table>
  ...
  <table width=95% align=center border=0 cellpadding=0 cellspacing=0>    
     <tr nowrap> 
      <td width="120"  class=td_form01>人员基本情况</td>
      <td  class=td_form02>
      <textarea rows="4" name="S2" cols="80"></textarea></td>     
    </tr>
    <tr nowrap> 
      <td  class=td_form01>部门面试审核意见</td>
      <td  class=td_form02> 
        <textarea rows="4" name="S1" cols="80"></textarea></td>
    </tr>
    <tr nowrap> 
      <td  class=td_form01>人事教育部<br>
      面试审核意见</td>
      <td  class=td_form02>
      <textarea rows="4" name="S2" cols="80"></textarea></td>     
    </tr>
    <tr nowrap> 
      <td  class=td_form01>心理测试结果</td>
      <td  class=td_form02> 
        <textarea rows="4" name="S1" cols="80"></textarea></td>
    </tr>
    <tr nowrap>
      <td  class=td_form01>体检结果</td>
      <td  class=td_form02>
        <textarea rows="4" name="S2" cols="80"></textarea></td>
    </tr>
    <tr nowrap>
      <td  class=td_form01>收件人</td>
      <td  class=td_form02><span class="td_page">
        <input type="text" name="outdate1" id="40" next="45" onKeyPress="gotoNextInput(this)" onFocus="{obtainFocus(this),this.select()}" class="input" alt="?áê?ê±??|1|d">
      </span></td>
    </tr>
