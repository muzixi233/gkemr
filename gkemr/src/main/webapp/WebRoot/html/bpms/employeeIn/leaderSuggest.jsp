    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">录入审批意见</td>
          </tr>
      </table></td>
    </tr>
  </table>
<br>
  <table width=95% align=center border=0 cellpadding=0 cellspacing=0>
    <tr nowrap> 
      <td width="110" class=td_form01>审批意见</td>
      <td class=td_form02> 
    ...
    <tr nowrap> 
      <td  class=td_form01>进入本单位日期</td>
      <td  class=td_form02> 
        <input  name="A001015" type="text" class="input"  id="A001015" onFocus="{obtainFocus(this),this.select()}" onBlur="matchInput(this)" onKeyPress="gotoNextInput(this)"  value="" size="20" alt="招聘岗位编制人数|1|a|||" next="A001016"  formula='ageExact(A001013)'>
