...
function forTabDetail(){
	...
	{
	  document.frames("detail").document.all("activeForm").action="curworkconditioninfoDetail.htm";
	  document.frames("detail").document.all("activeForm").submit();
	}
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom"><span class="title">发送邮件</span></td>
          </tr>
      </table></td>
    </tr>
  </table>
  ...
  <table width=95% align=center border=0 cellpadding=0 cellspacing=0>    
    <tr nowrap> 
      <td width="90"  class=td_form01>收信人</td>
      <td  class=td_form02> 
        <input  name="A001015" type="text" class="input"  id="A001015" next="A001016" alt="招聘岗位编制人数|1|a|||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)"  formula='ageExact(A001013)'  value="">
        <input type="button"  class="button_select" onClick="fPopUpCalendarDlg('A001027')"></td>
    </tr>  
     <tr nowrap> 
      <td  class=td_form01>发送内容</td>
      <td  class=td_form02 colspan="3"> 
       <textarea rows="8" name="S1" cols="80"></textarea></td>
    </tr>   
  </table>
<br>
...
<tr>
<td align="center">
<input name=save  type=button class=buttonface value= '  发送  '  onclick="self.close()">
