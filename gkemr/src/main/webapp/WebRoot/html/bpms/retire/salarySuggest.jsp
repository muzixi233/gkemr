...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr nowrap> 
    ...
    <input name="A001013" type="text" class="input"   id="A001013" next="A001014" alt="招聘岗位|1|d|||" value="" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" size="20" >&nbsp; </td>
      <td  class=td_form01>退休工资标准比例</td>
      <td  class=td_form02> 
    ...
    <tr nowrap> 
      ...
      <td  class=td_form01>工龄工资</td>
      <td  class=td_form02> 
      <input name="A1033" type="text" class="input"   id="A1033" next="A001028" alt="出国时间|1|d|||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" size="20" value="">&nbsp; </td>
    </tr>
    <tr nowrap> 
      <td  class=td_form01>津贴补贴</td>
      <td  class=td_form02> 
    ...
    <tr nowrap> 
      ...
      <font color=red></font> </td>
      <td  class=td_form01>历年社会平均增资</td>
      <td  class=td_form02> 
    ...
    <tr nowrap> 
      <td  class=td_form01>企业补贴</td>
      <td  class=td_form02> 
        <input name="A001013" type="text" class="input"   id="A001013" next="A001014" alt="招聘岗位|1|d|||" value="" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" size="20" >&nbsp;
      <font color=red></font> </td>
      <td  class=td_form01>合计</td>
      <td  class=td_form02> 
      <input name="A1033" type="text" class="input"   id="A1033" next="A001028" alt="出国时间|1|d|||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" size="20" value="">&nbsp; </td>
    </tr>
   
     <tr nowrap> 
       <td  class=td_form01>第一次调整</td>
       <td  class=td_form02 colspan="3"> 
        <input name="A001013" type="text" class="input"   id="A001013" next="A001014" alt="招聘岗位|1|d|||" value="" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" size="80" >
        &nbsp;
       <font color=red></font> </td>
    </tr> 
     <tr nowrap> 
      <td  class=td_form01>第二次调整</td>
      <td  class=td_form02 colspan="3"> 
        <input name="A001013" type="text" class="input"   id="A001013" next="A001014" alt="招聘岗位|1|d|||" value="" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" size="80" >
        &nbsp;
       <font color=red></font> </td>
