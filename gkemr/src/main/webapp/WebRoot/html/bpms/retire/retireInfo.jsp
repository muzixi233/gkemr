...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">录入离退休信息</td>
          </tr>
      </table></td>
    </tr>
  </table>
  ...
  <table width=95% align=center border=0 cellpadding=0 cellspacing=0 >
    ...
    <tr nowrap> 
      <td  class=td_form01>退休证编号</td>
      <td  class=td_form02> 
      <input  name="folk" type="text" class="input"  id="A001015" next="A001016" alt="招聘岗位编制人数|1|a|||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)"  formula='ageExact(A001013)'  value="" size="20"> </td>
      <td  class=td_form01>　</td>
      <td  class=td_form02> 
      　</td>
    </tr>   
    <tr nowrap> 
      <td  class=td_form01>安置地点</td>
