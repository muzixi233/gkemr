...
<td width='90' align='center' class='td_form01'>社会工龄</td>
<td class='td_form02'>35年</td>
<td width='90' align='center' class='td_form01'>公司工龄</td>
<td class='td_form02'>30年</td>
</tr>
</table>
<br>
   ...
   <td class="td07"><a href="salarySuggest.jsp" target="_blank">录入退休工资信息</a></td>
   </tr>
        <tr>
        ...
        <tr>
          <td align="center" class="td07">3</td>
           <td class="td07"><a href="newWork.jsp" target="_blank">查看分公司离退休审批表</a></td>
          </tr>
</table>
<!-- generate attachment -->
<!--submit task-->
