          ...
          <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="200" align="center" valign="top" class="explorer" id=menubar><br>
                ...
                <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" valign="bottom"><input name="Submit" type="button" class="buttonface" onClick="windowOpen('query.jsp','','','400','300','no','100','100')" value="新建查询">
                    </td>
                  </tr>
                </table>
                <form name="form1" method="post" action="table_01.jsp" target="rs">
                <table width="100%"  border="0" cellspacing="0" cellpadding="0" style="visibility:hidden" id="result">
                  <tr>
                    <td align="center"><span class="F02">符合查询条件的人员</span>
                      ...
                      <table width="90%"  border="0" cellpadding="2" cellspacing="0" class="td01">
                        <tr>
                          <td width="30" height="25" align="center" class="td02">
                            <input type="checkbox" name="checkbox" value="checkbox">
                          </td>
                          <td width="50" class="td02">姓名</td>
                          <td width="25" align="center" class="td02">
                            <input type="checkbox" name="checkbox" value="checkbox">
                          </td>
                          <td class="td02">姓名</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td height="20" align="center" class="td03">
                            <input type="checkbox" name="checkbox" value="checkbox">
                          </td>
                          <td class="td05">张建树</td>
                          <td align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">徐莉</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td height="20" align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">王明</td>
                          <td align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">刘培</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td height="20" align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">刘海涛</td>
                          <td align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">万海鹏</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td height="20" align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">石磊</td>
                        ...
                        <tr bgcolor="#FFFFFF">
                          ...
                          <td class="td05">王斌</td>
                          <td align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">许凌志</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td height="20" align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">戴晓颖</td>
                          <td align="center" class="td03"><input type="checkbox" name="checkbox" value="checkbox"></td>
                          <td class="td05">孙鹏</td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                      ...
                      <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="30" valign="bottom"><input name="Submit" type="submit" class="buttonface" value="生成花名册">
                          </td>
                        </tr>
                      </table>
                      </td>
