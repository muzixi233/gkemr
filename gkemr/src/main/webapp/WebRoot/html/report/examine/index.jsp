    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">信息报表</td>
          </tr>
      </table></td>
    </tr>
  </table>
                    ...
                    <div id="menu_1" style="DISPLAY: visible">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td nowrap><a href="checkin/table.jsp" target="rs" class="a03">干部任免审批表</a></td>
                        </tr>
                      </table>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="19"><img src="../../../images/tree_27.gif" width="19" height="20"></td>
                        <td nowrap><a href="../../employee/report/list.jsp" target="list" class="a03">花名册</a></td>
                      </tr>
                    </table>
                      <div id="menu_2" style="DISPLAY: visible">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="19"><img src="../../../images/tree_07.gif" width="19" height="20"></td>
                            <td width="19"><img src="../../../images/tree_14.gif" width="19" height="20"></td>
                            <td nowrap><a href="roster/query.jsp" target="rs" class="a03">人员名册</a></td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                      ...
                      <div id="menu_3" style="DISPLAY: visible">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="19"><img src="../../../images/tree_07.gif" width="19" height="20"></td>
                            <td width="19"><img src="../../../images/tree_14.gif" width="19" height="20"></td>
                            <td nowrap><a href="statistic/table.jsp" target="rs" class="a03">人才基本情况统计表</a></td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
