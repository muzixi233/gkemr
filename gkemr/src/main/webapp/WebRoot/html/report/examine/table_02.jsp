  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td align="right" valign="top" class="sec3">
        <input name="Submit" type="submit" class="buttonface" value="  查询  " onClick="parent.location.href='detail.jsp'">
      </td>
    </tr>
  </table>
  <table border="0" cellspacing="0" cellpadding="3" width="95%" height="240" id=mainTable class="main_tab">
    <tbody style="display:block;">
      <tr>
        <td align="center" valign=top> 
          ...
          <table width="100%"  border="0" cellpadding="3" cellspacing="1" class="td01">
            <tr>
                <td width="90" align="center" bgcolor="#FFFFFF" class="td05">姓名</td>
                <td bgcolor="#FFFFFF">徐莉</td>
                <td width="90" align="center" bgcolor="#FFFFFF" class="td05">性别</td>
                <td width="90" bgcolor="#FFFFFF">女</td>
                <td width="90" align="center" bgcolor="#FFFFFF" class="td05">出生年月<br>
              （）岁</td>
                <td bgcolor="#FFFFFF">1979-01-15<br>
                  （25）岁</td>
                <td width="90" rowspan="4" align="center" bgcolor="#FFFFFF">照片</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF">1999-10-22</td>
              <td align="center" bgcolor="#FFFFFF" class="td05">参加工作时间</td>
              <td bgcolor="#FFFFFF">2001-05-15</td>
      ...
      <tr>
        <td align=center valign=top><table width="100%"  border="0" cellpadding="2" cellspacing="1" class="td01">
          <tr>
            ...
            <td colspan="5" valign="top" bgcolor="#FFFFFF" class="F03">1、首届全国大学生电子商务竞赛知识赛<br>
      ...
      重要社会关系</td>
          ...
          <tr>
            ...
            <td colspan="5" bgcolor="#FFFFFF"><table width="80%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="60" align="right" valign="bottom" class="F03">（盖章）<br>
呈报单位日期</td>
              </tr>
            </table>
              </td>
