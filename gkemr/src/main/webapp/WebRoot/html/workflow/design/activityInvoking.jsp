...
<center>
   ...
   <table width="95%" border="0" cellpadding="0" cellspacing="0" class="table01">
     <tr>
       <td align="center" class="td_top"><input type="checkbox" name="checkbox" value="checkbox">
       </td>
       <td align="center" class="td_top">序号</td>
       <td class="td_top">调用编号</td>
       <td class="td_top">名称</td>
       <td class="td_top">访问路径</td>
       <td class="td_top">&nbsp;</td>
     </tr>
     <tr>
       ...
       <td class="td_01">IK0001</td>
       <td class="td_01"><a href="activityInvokingEdit.jsp">录入出国人员基本信息</a></td>
       <td class="td_01">/abp/inputbaseinfo.do</td>
       <td class="td_01"><input name="Button" type="button" class="buttonface" onClick="javascript:location.href='parameterMapping.jsp'" value="映射参数">
       </td>
     </tr>
     <tr>
       <td align="center" class="td_01"><input type="checkbox" name="checkbox" value="checkbox">
       ...
       <td class="td_01">IK0002</td>
       <td class="td_01">&nbsp;</td>
       <td class="td_01">&nbsp;</td>
       <td class="td_01"><input name="Button" type="button" class="buttonface" onClick="javascript:location.href='parameterMapping.jsp'" value="映射参数"></td>
     </tr>
  </table>
   <br>
   <table width="95%"  border="0" cellpadding="0" cellspacing="0" class="table02">
     <tr>
       <td align="center"><input name="Button" type="button" class="buttonface" onClick="javascript:location.href='activityInvokingEdit.jsp'" value="  增加  ">
