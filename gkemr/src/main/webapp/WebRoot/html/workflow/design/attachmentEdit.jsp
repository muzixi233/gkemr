...
<center>
    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">附件定义</td>
          </tr>
      </table></td>
    </tr>
  </table>
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="2">
    <tr>
      ...
      <td class="F03">流程名称:出国手续办理</td>
    </tr>
  </table>
  <table width="95%" border="0" cellpadding="0" cellspacing="0" class="table02">
    <tr>
      <td width="100" height="24" class="td_form01"><p>附件编号</p>
      </td>
      <td class="td_form02">AM0001</td>
    </tr>
    <tr>
      <td class="td_form01">附件名称</td>
    ...
    <tr>
      <td height="28" class="td_form01">最大值（M）</td>
      <td class="td_form02"><input name="textfield" type="text" class="input"></td>
    </tr>
    <tr>
      <td class="td_form01">附件类别</td>
