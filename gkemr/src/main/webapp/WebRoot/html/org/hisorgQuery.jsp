...
function forAdd(form,type){
    ...
    if(reval!=null&&reval!=""){
        ...
        return true;*/
		reval=window.showModalDialog("info/pmporgQuery.jsp", "dialogWidth:400px; dialogHeight:180px;center:center;resizable:no;status:no;" );
    }
	window.open("info/pmporgQuery.jsp","","top=250,left=50,height=300px,width=800px,status=no,toolbar=no,menubar=no,location=no,resizable=yes,scrollbars=yes");
...
function forEdit(form,type,id){
 ...
 //  url+="&fk="+form.fk.value;
    window.open("history/orgHisView.jsp","","top=250,left=50,height=500px,width=800px,status=no,toolbar=no,menubar=no,location=no,resizable=yes,scrollbars=yes");
}
