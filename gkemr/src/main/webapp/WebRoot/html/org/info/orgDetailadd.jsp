...
<input  id="ORGUID"  next="B002001" name="ORGUID" type="hidden" class="input" value='10026'><tr nowrap>
<td width="90" class=td_form01 >机构名称</td>
<td  class=td_form02><input name="B002001" type="text" class="input"   id="B002001" next="B002002" alt="机构名称|0|s|50||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)"  value="rewrewr"> <font color=red></font>
</td>
<td width="90" class=td_form01 >机构简称</td>
<td  class=td_form02><input name="B002002" type="text" class="input"   id="B002002" next="B002003" alt="机构简称|1|s|50||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)"  value=""> <font color=red></font>
</td>
</tr>
<tr nowrap>
<td class=td_form01 >联系电话</td>
<td  class=td_form02><input name="B002003" type="text" class="input"   id="B002003" next="B002004" alt="联系电话|1|s|50||" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)"  value=""> <font color=red></font>
</td>
<td  class=td_form01 >显示顺序</td>
<td  class=td_form02><input name="B002004" type="text" class="input"   id="B002004" next="" alt="显示顺序|1|i||0|99" formula=''  value="99" onFocus="{obtainFocus(this),this.select()}" onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)" > <font color=red></font>
</td>
</tr>
</table>
<br>
...
<input type=hidden name=fk value='10026'>
<input type=hidden name=setId value='B002'>
<input type=hidden name=pk value='10026'>
<script language="javascript">
...
<div  id=seryFilterDiv onMouseDown ="catchFilter()" onMouseUp ="releaseFilter()" style="cursor:move;position:absolute;z-index:0;left:650px;top:0px;display:none;">
    <img id=showZP src="/photoServlet?itemId=&pkvalue=10026" width=110 height=140 alt="照片">
</div>
