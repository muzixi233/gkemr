    ...
    <tr>
      <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td valign="bottom" class="title">综合查询</td>
          </tr>
      </table></td>
    </tr>
  </table>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><input name="Button2" type="button" class="buttonface" value="  查询  ">
      <input name="Button2" type="button" class="buttonface" value="  保存  "></td>
  </tr>
</table>
<br>
<script>
