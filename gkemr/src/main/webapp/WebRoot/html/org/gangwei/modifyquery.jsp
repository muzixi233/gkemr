...
<form name="" action="" method="post">
  ...
  <tr>
    ...
    <td colspan="3" class="td_form02"><input name="checkbox" type="text" class="input" value="档案不在库人员" size="50" >      
...
保存为默认查询 </td>
  ...
  <tr>
    ...
    <td colspan="3" class="td_form02"><textarea name="viewfield" cols="80" rows="4" >,员工编号,姓名,性别,年龄,民族,政治面貌,户口所在地,进入本单位时间,婚姻状况,身份证号</textarea></td>
    </tr>
  <tr>
    <td colspan="4" class="td_02">
        ...
        <table width="100%"  border="0" id="baseinfo" style="display:visible ">
          <tr>
