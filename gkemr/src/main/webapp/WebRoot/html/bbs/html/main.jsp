      ...
      <tr>
        ...
        <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="35" align="right"><a href="bpms/undo.jsp" target="_blank"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
          </tr>
          <tr>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td valign="top" class="td08"><span class="td07"><a href="bpms/employeeIn/deptSuggest.jsp" target="_blank">刘岳 提交新闻申报办理时间 2005-10-15</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><span class="td07"><a href="bpms/employeeIn/shen_pi_qingjia.jsp" target="_blank">张三 提交请假申请 办理时间 2005-09-30</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><span class="td07"><a href="bpms/employeeIn/ke_ti_jiekuan_shenpi.jsp" target="_blank">张三 提交课题借款申请 办理时间 2005-09-30</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><span class="td07"><a href="bpms/employeeIn/shen_pi_yiliao_baoxiao.jsp" target="_blank">张三 提交医疗借款</a><a href="employeeIn/leaderSuggest.jsp" target="_blank">办理时间 2005-09-30</a></span></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
          ...
          <tr>
            ...
            <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="35" align="right"><img src="../images/main_53.gif" width="35" height="9"></td>
                </tr>
                <tr>
                  <td height="1" class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                  <td class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">2004-12-23下午在407举行人力资源部年度考核大会，请准时参加</a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>
