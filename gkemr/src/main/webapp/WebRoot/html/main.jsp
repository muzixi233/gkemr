      ...
      <tr>
        ...
        <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="35" align="right"><a href="bpms/undo" target="mainFrame"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
          </tr>
          <tr>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td valign="top" class="td08"><a href="bpms/employeeIn/leaderSuggest" target="_blank"> <a href="bpms/employeeIn/shen_pi_qingjia" target="_blank">李某 提交请假待审批办理时间 2005-10-15</a></a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/shen_pi_qingjia" target="_blank">张三 提交请假待审批 办理时间 2005-09-30</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/ke_ti_jiekuan_shenpi" target="_blank">张三 提交课题借款待审批 办理时间 2005-09-30</a></span></td>
                    </tr>
                    <tr>
                      <td><img src="../images/index_57.gif" width="15" height="16"></td>
                      <td valign="top" class="td08"><a href="bpms/employeeIn/shen_pi_yiliao_baoxiao" target="_blank">张三 提交医疗借款待审批办理时间 2005-09-30</a></span></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
          ...
          <tr>
            ...
            <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="35" align="right"><a href="ti_xing/ti_xing" target="mainFrame"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
                </tr>
                <tr>
                  <td height="1" class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                  <td class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi" target="_blank">刘岳 提交新闻申报以通过时间 2005-10-15</span></a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi" target="_blank">张三 提交新闻申报未通过时间 2005-09-30</span></a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi" target="_blank">张三 提交请假申请退回时间 2005-09-30</span></a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="ti_xing/xiang_xi_xinxi" target="_blank">张三 提交撤消请假通过时间 2005-09-30</span></a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>
          ...
          <tr>
            ...
            <td align="center" class="td01"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="35" align="right"><a href="message/message"><img src="../images/main_53.gif" width="35" height="9" border="0"></a></td>
                </tr>
                <tr>
                  <td height="1" class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
                  <td class="td05"><img src="../images/spacer.gif" width="1" height="1"></td>
...
//  End -->
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><a href="tongxunlu/index" target="mainFrame" class="a03">个人通讯录</a><br>
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><a href="../html/PersonalSet/showset" class="a03">个人设置</a><br>
                  <img src="../images/main_50.gif" width="43" height="9"></td>
            </tr>
    </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
